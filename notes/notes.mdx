...
Task: Outline the benefits of monorepos.

Task: Outline the disavanatages of monorepos.
...
Your task is to install pnpm.

To verify your installation, check the version of pnpm installed. It should be `9` or the latest version.
