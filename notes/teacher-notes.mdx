...
Your task is to set up a basic monorepo structure and create a script to run a JavaScript file. Here are the steps you need to follow:

1. Your first task is to create a new directory named packages. Within this directory, your challenge is to create a new package. Name this package firelane-one. Once you've done this, go to the root of your project and set up a pnpm workspace.

2. Now, navigate to the firelane-one package you just created. Here, your challenge is to add a new file named index.js. This file should include a function named calculateLeaves. After you've done this, go back to the root of your project. Here, your task is to create a script that can execute a JavaScript file.
